<?php
// Fixed debug script for Windows

error_reporting(E_ALL);
ini_set('display_errors', 1);
ini_set('log_errors', 1);

echo "<h2>🔍 Fixed Competition API Debug</h2>";
...
// Test 4: Check headers (Windows compatible)
echo "<h3>📡 Headers Test:</h3>";
echo "<pre>";
foreach (getallheaders_fix() as $name => $value) {
    echo "$name: $value\n";
}
echo "</pre>";
...
// Function to get headers in a Windows-compatible way
function getallheaders_fix() {
    $headers = [];
